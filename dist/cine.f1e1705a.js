...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pelicula.js":[function(require,module,exports) {
"use strict";
...
var cartelera = function cartelera(peliculas) {
  document.querySelector('#cine').innerHTML = peliculas.map(function (pelicula) {
    ...
    var porcentaje = pelicula.porcentajef();

    if (porcentaje == 100) {
      porcentaje = "<strong>".concat(pelicula.porcentajef(), "</strong>");
    } else {
      porcentaje = pelicula.porcentajef();
    }

    return "<div id='cartelera'>\n                <h3>".concat(name, "</h3>\n                <p>A\xF1o de estreno: ").concat(year, "</p>\n                <p>Sillas ocupadas: ").concat(people, "</p>\n                <p>Capacidad: ").concat(capacity, "</p>\n                <p>Porcentaje: ").concat(porcentaje, "</p>\n              </div>");
  });
};

exports.cartelera = cartelera;
},{}],"listado.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.listado = void 0;

var listado = function listado(peliculas) {
...
var _pelicula = _interopRequireDefault(require("./pelicula"));

var _cartelera = require("./cartelera");

var _listado = require("./listado");
...
var peliculas = [];
(0, _cartelera.cartelera)(peliculas);
(0, _listado.listado)(peliculas);
document.querySelector('#nueva').addEventListener('click', function () {
  var pelicula = document.querySelector('#datos').value.split(',');
  var p = new _pelicula.default(pelicula[0], pelicula[1], pelicula[2], pelicula[3], pelicula[4]);
  peliculas.push(p);
  (0, _cartelera.cartelera)(peliculas);
  (0, _listado.listado)(peliculas);
});
document.querySelector('#guardar').addEventListener('click', function () {
  ...
  var peliculaSeleccionada = _toConsumableArray(document.querySelector('#pelicula').selectedOptions).shift().value;
...
},{"./pelicula":"pelicula.js","./cartelera":"cartelera.js","./listado":"listado.js"}],"../../../AppData/Roaming/nvm/v14.5.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/nvm/v14.5.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","cine.js"], null)
