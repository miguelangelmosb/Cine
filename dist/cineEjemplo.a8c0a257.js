...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"cineEjemplo.js":[function(require,module,exports) {
...
var cartelera = function cartelera() {
  document.querySelector('#cine').innerHTML = peliculas.map(function (pelicula) {
    ...
    var porcentaje = pelicula.porcentaje1();

    if (porcentaje === 100) {
      porcentaje = "<strong>".concat(pelicula.porcentaje1(), "</strong>");
    } else {
      porcentaje = pelicula.porcentaje1();
    }

    return "<div>\n                <h3>".concat(name, "</h3>\n                <p>A\xF1o de estreno: ").concat(year, "</p>\n                <p>Personas en cine: ").concat(people, "</p>\n                <p>Capacidad: ").concat(capacity, "</p>\n                <p>Procentaje: ").concat(porcentaje, "</p>\n              </div>");
  });
};
...
document.querySelector('#nueva').addEventListener('click', function () {
  ...
  var p = new Peliculas(pelicula[0], pelicula[1], pelicula[2], pelicula[3], pelicula[4]);
  peliculas.push(p);
  cartelera();
  listado();
});
...
},{}]},{},["../../../AppData/Roaming/nvm/v14.5.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","cineEjemplo.js"], null)
//# sourceMappingURL=/cineEjemplo.a8c0a257.js.map